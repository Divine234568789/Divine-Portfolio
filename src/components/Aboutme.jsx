    ...
    <div>
      <section className="ml-30">
        <div className="flex gap-40 items-center">
          ...
          <div className="ml-40">
            <img src="/Dots.png" alt="" className="z-10 relative top-35" />
            <img
              src="/Dots2.png"
              alt=""
      ...
      <section className="ml-30 ">
        ...
        <img src="/Dots.png" alt="" className="left-235 bottom-60 relative " />
        <img src="/logo2.png" alt="" className="left-266 bottom-60 relative " />
      </section>
    </div>
  );
};
