    ...
    <div>
      <section className="ml-30">
        <div className="flex gap-40 items-center">
          ...
          <div className="ml-40">
            <img src="public/Dots.png" alt="" className="z-10 relative top-35" />
            <img
              src="public/Dots2.png"
              alt=""
              className="relative top-80 left-50 z-10"
            />
            <img src="public/me2.png" alt="" className="bottom-15 relative" />
      ...
      <section className="ml-30 ">
        ...
        <img src="public/Dots.png" alt="" className="left-235 bottom-60 relative " />
        <img src="public/logo2.png" alt="" className="left-266 bottom-60 relative " />
      </section>
    </div>
  );
};
